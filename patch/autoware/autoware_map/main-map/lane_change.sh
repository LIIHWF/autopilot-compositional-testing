if ! cmp -s patch/autoware/autoware_map/main-map/lane_change.osm patch/autoware/autoware_map/main-map/lanelet2_map.osm; then
    cp patch/autoware/autoware_map/main-map/lane_change.osm patch/autoware/autoware_map/main-map/lanelet2_map.osm
