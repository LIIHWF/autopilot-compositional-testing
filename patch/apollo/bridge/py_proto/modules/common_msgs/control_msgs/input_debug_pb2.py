...
_INPUTDEBUG.fields_by_name['localization_header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_INPUTDEBUG.fields_by_name['canbus_header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_INPUTDEBUG.fields_by_name['trajectory_header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_INPUTDEBUG.fields_by_name['latest_replan_trajectory_header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
