...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2.DESCRIPTOR,])
...
_PADMESSAGE.fields_by_name['driving_mode'].enum_type = modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2._CHASSIS_DRIVINGMODE
