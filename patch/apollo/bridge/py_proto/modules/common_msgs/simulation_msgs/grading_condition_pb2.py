...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2.DESCRIPTOR,])
...
_WORKINGZONEAVOIDLIMITCONDITION.fields_by_name['working_zone'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._POLYGON
_WORKINGZONEAVOIDLIMITCONDITION.fields_by_name['whole_area'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._POLYGON
_LIMITEDTIMEPARKINGCONDITION.fields_by_name['parking_lot'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._POLYGON
_FOLLOWANDBYPASSCONDITION.fields_by_name['test_range'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._POLYGON
_FOLLOWANDBYPASSCONDITION.fields_by_name['end_line'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._LINESEGMENT
_OBSTACLEBYPASSCONDITION.fields_by_name['test_range'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._POLYGON
