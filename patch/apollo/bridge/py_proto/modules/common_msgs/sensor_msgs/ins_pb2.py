...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2.DESCRIPTOR,])
...
_INSSTAT.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_INS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_INS.fields_by_name['type'].enum_type = _INS_TYPE
_INS.fields_by_name['position'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINTLLH
_INS.fields_by_name['euler_angles'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_INS.fields_by_name['linear_velocity'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_INS.fields_by_name['angular_velocity'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_INS.fields_by_name['linear_acceleration'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
