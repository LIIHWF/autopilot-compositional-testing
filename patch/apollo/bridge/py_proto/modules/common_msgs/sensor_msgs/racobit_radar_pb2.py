...
_RACOBITRADARSTATE_201 = _descriptor.Descriptor(
  ...
  nested_types=[],
  enum_types=[
    _RACOBITRADARSTATE_201_OUTPUTTYPE,
    _RACOBITRADARSTATE_201_RCSTHRESHOLD,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto2',
...
_RACOBITRADARSTATE_201.fields_by_name['output_type'].enum_type = _RACOBITRADARSTATE_201_OUTPUTTYPE
_RACOBITRADARSTATE_201.fields_by_name['rcs_threshold'].enum_type = _RACOBITRADARSTATE_201_RCSTHRESHOLD
...
_RACOBITRADAROBS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_RACOBITRADAR.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
