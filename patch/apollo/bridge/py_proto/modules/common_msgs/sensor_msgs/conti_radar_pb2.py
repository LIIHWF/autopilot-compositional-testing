...
_RADARSTATE_201 = _descriptor.Descriptor(
  ...
  nested_types=[],
  enum_types=[
    _RADARSTATE_201_OUTPUTTYPE,
    _RADARSTATE_201_RCSTHRESHOLD,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto2',
...
_CONTIRADAROBS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_CONTIRADAR.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
