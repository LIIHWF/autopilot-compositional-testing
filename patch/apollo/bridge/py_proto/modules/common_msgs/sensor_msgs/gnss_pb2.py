...
_GNSS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_GNSS.fields_by_name['position'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINTLLH
_GNSS.fields_by_name['position_std_dev'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_GNSS.fields_by_name['linear_velocity'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_GNSS.fields_by_name['linear_velocity_std_dev'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_GNSS.fields_by_name['type'].enum_type = _GNSS_TYPE
_GNSS_TYPE.containing_type = _GNSS
_RAWDATA.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
