...
_CORRECTEDIMU.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_CORRECTEDIMU.fields_by_name['imu'].message_type = modules_dot_common__msgs_dot_localization__msgs_dot_pose__pb2._POSE
