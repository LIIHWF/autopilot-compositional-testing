...
_TRANSFORM.fields_by_name['translation'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_TRANSFORM.fields_by_name['rotation'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._QUATERNION
_TRANSFORMSTAMPED.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_TRANSFORMSTAMPED.fields_by_name['transform'].message_type = _TRANSFORM
_TRANSFORMSTAMPEDS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
