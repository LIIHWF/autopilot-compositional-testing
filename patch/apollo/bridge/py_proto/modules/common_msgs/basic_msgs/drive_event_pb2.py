...
# source: modules/common_msgs/basic_msgs/drive_event.proto
...
_DRIVEEVENT.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_DRIVEEVENT.fields_by_name['location'].message_type = modules_dot_common__msgs_dot_localization__msgs_dot_pose__pb2._POSE
