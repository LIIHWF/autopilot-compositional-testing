...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_basic__msgs_dot_error__code__pb2.DESCRIPTOR,])
...
_HEADER.fields_by_name['status'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_error__code__pb2._STATUSPB
