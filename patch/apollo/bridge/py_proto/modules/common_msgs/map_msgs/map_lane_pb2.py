...
_LANEBOUNDARY.fields_by_name['curve'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._CURVE
_LANEBOUNDARY.fields_by_name['boundary_type'].message_type = _LANEBOUNDARYTYPE
_LANE.fields_by_name['id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['central_curve'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._CURVE
...
_LANE.fields_by_name['overlap_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['predecessor_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['successor_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['left_neighbor_forward_lane_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['right_neighbor_forward_lane_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['type'].enum_type = _LANE_LANETYPE
_LANE.fields_by_name['turn'].enum_type = _LANE_LANETURN
_LANE.fields_by_name['left_neighbor_reverse_lane_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['right_neighbor_reverse_lane_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_LANE.fields_by_name['junction_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
...
_LANE.fields_by_name['self_reverse_lane_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
