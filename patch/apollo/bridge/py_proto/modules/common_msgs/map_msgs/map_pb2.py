...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_map__msgs_dot_map__clear__area__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__crosswalk__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__junction__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__lane__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__overlap__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__parking__space__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__pnc__junction__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__road__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__rsu__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__signal__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__speed__bump__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__stop__sign__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_map__msgs_dot_map__yield__sign__pb2.DESCRIPTOR,])
...
_MAP.fields_by_name['crosswalk'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__crosswalk__pb2._CROSSWALK
_MAP.fields_by_name['junction'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__junction__pb2._JUNCTION
_MAP.fields_by_name['lane'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__lane__pb2._LANE
_MAP.fields_by_name['stop_sign'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__stop__sign__pb2._STOPSIGN
_MAP.fields_by_name['signal'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__signal__pb2._SIGNAL
_MAP.fields_by_name['yield'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__yield__sign__pb2._YIELDSIGN
_MAP.fields_by_name['overlap'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__overlap__pb2._OVERLAP
_MAP.fields_by_name['clear_area'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__clear__area__pb2._CLEARAREA
_MAP.fields_by_name['speed_bump'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__speed__bump__pb2._SPEEDBUMP
_MAP.fields_by_name['road'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__road__pb2._ROAD
_MAP.fields_by_name['parking_space'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__parking__space__pb2._PARKINGSPACE
_MAP.fields_by_name['pnc_junction'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__pnc__junction__pb2._PNCJUNCTION
_MAP.fields_by_name['rsu'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__rsu__pb2._RSU
