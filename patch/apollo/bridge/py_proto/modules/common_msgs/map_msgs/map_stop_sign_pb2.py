...
_STOPSIGN.fields_by_name['id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
_STOPSIGN.fields_by_name['stop_line'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__geometry__pb2._CURVE
_STOPSIGN.fields_by_name['overlap_id'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__id__pb2._ID
