...
from modules.common_msgs.control_msgs import control_cmd_pb2 as modules_dot_common__msgs_dot_control__msgs_dot_control__cmd__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_control__msgs_dot_control__cmd__pb2.DESCRIPTOR,])
...
_GUARDIANCOMMAND.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_GUARDIANCOMMAND.fields_by_name['control_command'].message_type = modules_dot_common__msgs_dot_control__msgs_dot_control__cmd__pb2._CONTROLCOMMAND
