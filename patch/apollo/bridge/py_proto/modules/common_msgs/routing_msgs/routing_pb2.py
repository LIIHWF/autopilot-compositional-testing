...
_DEADENDINFO.fields_by_name['target_point'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINTENU
...
_ROUTINGREQUEST.fields_by_name['parking_space'].message_type = modules_dot_common__msgs_dot_map__msgs_dot_map__parking__space__pb2._PARKINGSPACE
