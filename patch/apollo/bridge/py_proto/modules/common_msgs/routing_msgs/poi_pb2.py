...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_routing__msgs_dot_routing__pb2.DESCRIPTOR,])
...
_LANDMARK.fields_by_name['waypoint'].message_type = modules_dot_common__msgs_dot_routing__msgs_dot_routing__pb2._LANEWAYPOINT
_LANDMARK.fields_by_name['parking_info'].message_type = modules_dot_common__msgs_dot_routing__msgs_dot_routing__pb2._PARKINGINFO
