...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_audio__msgs_dot_audio__common__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2.DESCRIPTOR,])
...
_AUDIODETECTION.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_AUDIODETECTION.fields_by_name['moving_result'].enum_type = modules_dot_common__msgs_dot_audio__msgs_dot_audio__common__pb2._MOVINGRESULT
_AUDIODETECTION.fields_by_name['position'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
