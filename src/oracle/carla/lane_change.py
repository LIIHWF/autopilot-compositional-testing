...
if data['collision'] == 'yes':
    ...
    ego_last_state = last_state['ego']
    arriving_last_state = last_state['arriving']
    ...
    if abs(last_ego_state['transform']['location']['x'] - -1.75) < 1.75 and last_ego_state['transform']['location']['y'] < last_arriving_state['transform']['location']['y']:
