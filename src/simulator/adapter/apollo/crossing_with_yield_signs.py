...
initial_world_state.set_vehicle_state(ARRIVING_ID,
                                      ApolloVehicleState(
                                          x=-12 - SHAPE.front_edge_to_center - args.xa, y=-1.75, v=Context.vl_mps, a=0, theta_radians=0, kappa=0,
                                          shape=SHAPE
                                      ))
...
with open('map_data/apollo/crossing_with_yield_signs.txt') as f:
